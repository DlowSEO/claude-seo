...
Open a [GitHub Issue](https://github.com/DlowSEO/claude-seo/issues) with:
...
Use [GitHub Discussions](https://github.com/DlowSEO/claude-seo/discussions) for feature ideas and questions.
